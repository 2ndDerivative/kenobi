...
pub struct ClientBuilder<'cred, Usage, S: SigningState, E: EncryptionState> {
    #[cfg(windows)]
    inner: kenobi_windows::client::ClientBuilder<'cred, Usage, S, E, NoDelegation>,
    #[cfg(unix)]
    inner: kenobi_unix::client::ClientBuilder<'cred, Usage, S, E, NoDelegation>,
}
impl<'cred, Usage, S: SigningState, E: EncryptionState> ClientBuilder<'cred, Usage, S, E> {
...
#[cfg(windows)]
impl<Usage> ClientBuilder<'_, Usage, NoSigning, NoEncryption> {
    #[must_use]
    pub fn new_from_credentials<'cred>(
        cred: &'cred Credentials<Usage>,
        target_principal: Option<&str>,
    ) -> ClientBuilder<'cred, Usage, NoSigning, NoEncryption> {
...
#[cfg(unix)]
impl<Usage: OutboundUsable> ClientBuilder<'_, Usage, NoSigning, NoEncryption> {
    #[must_use]
    pub fn new_from_credentials<'cred>(
        cred: &'cred Credentials<Usage>,
        target_principal: Option<&str>,
...
impl<'cred, Usage, E: EncryptionState> ClientBuilder<'cred, Usage, NoSigning, E> {
    #[must_use]
    pub fn request_signing(self) -> ClientBuilder<'cred, Usage, MaybeSigning, E> {
        let ClientBuilder { inner } = self;
        let inner = { inner.request_signing() };
        ClientBuilder { inner }
    }
    #[must_use]
    pub fn deny_signing(self) -> ClientBuilder<'cred, Usage, DeniedSigning, E> {
        let ClientBuilder { inner } = self;
...
impl<'cred, Usage, S: SigningState> ClientBuilder<'cred, Usage, S, NoEncryption> {
    #[must_use]
    pub fn request_encryption(self) -> ClientBuilder<'cred, Usage, S, MaybeEncryption> {
        let ClientBuilder { inner } = self;
